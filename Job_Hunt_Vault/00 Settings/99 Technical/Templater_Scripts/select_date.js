...
let dateString = await tp.system.suggester(["(write date)", "today", "tomorrow","yesterday", "> weekday", "> calendar"], ["(write date)", "today", "tomorrow", "yesterday", "> weekday", "> calendar"]);
